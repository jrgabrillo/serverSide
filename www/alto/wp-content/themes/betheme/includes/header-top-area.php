					...
					<?php 
						...
						echo $logo_before;
							...
							if( $textlogo ){
								...
								echo '<img class="logo-main   scale-with-grid'. $class .'" src="'. $logo_src .'" 	alt="'. get_bloginfo( 'name' ) .'" '. $width .'/>';
								echo '<img class="logo-sticky scale-with-grid'. $class .'" src="'. $logo_sticky .'" alt="'. get_bloginfo( 'name' ) .'" '. $width .'/>';
								echo '<img class="logo-mobile scale-with-grid'. $class .'" src="'. $logo_mobile .'" alt="'. get_bloginfo( 'name' ) .'" '. $width .'/>';
